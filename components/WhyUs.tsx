    ...
    <div className="py-24 bg-slate-50">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mb-16">
          <h2 className="text-primary-600 font-bold tracking-widest uppercase text-sm mb-4">Value + Trust</h2>
        ...
        <div className="mt-20 bg-primary-600 rounded-[2rem] p-10 md:p-16 relative overflow-hidden flex flex-col lg:flex-row items-center gap-12 text-white">
          <div className="flex-1 relative z-10">
            ...
            <a href="#contact" className="inline-block px-8 py-4 bg-white text-primary-600 rounded-xl font-bold shadow-lg transition-transform hover:scale-105 active:scale-95">
