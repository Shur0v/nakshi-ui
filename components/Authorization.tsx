...
const agreements = [
    { src: '/agreement3.jpg', label: 'Distribution Agreement — Page 1' },
    { src: '/agreement4.jpg', label: 'Distribution Agreement — Page 2' },
    { src: '/agreement1.jpg', label: 'Distribution Agreement — Page 3' },
    { src: '/agreement2.jpg', label: 'Distribution Agreement — Page 4' },
];
